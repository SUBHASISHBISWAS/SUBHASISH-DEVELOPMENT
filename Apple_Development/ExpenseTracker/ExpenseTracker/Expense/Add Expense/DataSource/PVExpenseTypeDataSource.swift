//
//  ExpenseTypePickerViewDataSource.swift
//  ExpenseTracker
//
...
class PVExpenseTypeDataSource: NSObject,UIPickerViewDataSource,UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        viewController._cardType.text = _data[row]
