...
namespace CalculatorClient.CalculatorService {
    ...
    public interface ICalculatorService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(CalculatorClient.CalculatorService.DivideByZeroFault), Action="http://tempuri.org/ICalculatorService/DivideDivideByZeroFaultFault", Name="DivideByZeroFault", Namespace="http://schemas.datacontract.org/2004/07/CalculatorService")]
        int Divide(int Numerator, int Denomerator);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICalculatorService/Divide", ReplyAction="http://tempuri.org/ICalculatorService/DivideResponse")]
        System.Threading.Tasks.Task<int> DivideAsync(int Numerator, int Denomerator);
    }
    ...
    public partial class CalculatorServiceClient : System.ServiceModel.ClientBase<CalculatorClient.CalculatorService.ICalculatorService>, CalculatorClient.CalculatorService.ICalculatorService {
        ...
        public int Divide(int Numerator, int Denomerator) {
            return base.Channel.Divide(Numerator, Denomerator);
        }
        
        public System.Threading.Tasks.Task<int> DivideAsync(int Numerator, int Denomerator) {
            return base.Channel.DivideAsync(Numerator, Denomerator);
        }
    }
}
